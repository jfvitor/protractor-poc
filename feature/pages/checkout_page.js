...
var CheckOutPage = function() {
    ...
    this.submitBtn = element(by.xpath('//*[@id="frmPersonalDataPass1"]/div/div[2]/div[1]/button'));
    ...
    this.submitBtnStep2 = element(by.xpath('//*[@id="frmDeliveryPass2"]/div/div[2]/div[1]/button'));

    //Step 3
    this.nameForm3 = element(by.id('frmDueDatePass3'));
    this.editStep1 = element(by.css('#frmDueDatePass3 > div > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > a'));
    this.editStep2 = element(by.css('#frmDueDatePass3 > div > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > a'));
    this.payDay = element(by.id('selPayDay'));
    this.finishBtn = element(by.xpath('//*[@id="frmDueDatePass3"]/div/div[2]/div[1]/button'));
    this.successMessage = element(by.xpath('/html/body/section[1]/article/div/div[1]/div[1]'));
};

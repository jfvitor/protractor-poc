...
describe('Purchasing a new post paid', () => {
    ...
    it('should fill out the step 0 form and move to step 1 form', async() => {
        await expect(checkoutpage.nameForm.isPresent()).toEqual(true);
        await expect(checkoutpage.nameField.isPresent()).toEqual(true);
        await checkoutpage.nameField.clear().sendKeys('Juliana');
        await checkoutpage.lastnameField.clear().sendKeys('Rodrigues');
    ...
    it('should fill out step 1 form and move to step 2 form', async() => {
        await expect(checkoutpage.nameForm.isPresent()).toEqual(true);
        await expect(checkoutpage.cpfField.isPresent()).toEqual(true);
    ...
    it('should fill out the step 2 form and move to step 3 form', async() => {
    ...
    it('should fill out the step 3 form and show the protocol number informing that the request was sent', async() => {

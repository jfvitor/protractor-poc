...
var Photographer = (function () {
    ...
    Photographer.prototype.photographWorkOf = function (actor) {
        ...
        var ignoreInactiveBrowserButReportAnyOther = function (error) {
        ...
        return this.stage.manager.informOfWorkInProgress(abilities_1.BrowseTheWeb.as(actor).takeScreenshot()
            .then(saveScreenshot).then(function (path) { return new domain_1.Photo(path); }, function (error) { return ignoreInactiveBrowserButReportAnyOther(error); }));
    };
    return Photographer;
}());
